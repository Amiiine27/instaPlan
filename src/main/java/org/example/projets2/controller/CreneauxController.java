...
public class CreneauxController implements Initializable {
    ...
    private void onCheckConflictsButtonClicked() {
        ...
        try {
            ...
            boolean conflitSalle = creneauxMemeSalle.stream()
                    ...
                    .anyMatch(c ->
                            ...
                            (debut.isBefore(c.getFin()) && fin.isAfter(c.getDebut()))
                    );
            ...
            boolean conflitEnseignant = creneauxMemeEnseignant.stream()
                    .anyMatch(c ->
                            // Vérifier si les horaires se chevauchent
                            (debut.isBefore(c.getFin()) && fin.isAfter(c.getDebut()))
                    );
    ...
    private void onDeleteButtonClicked() {
        ...
        if (showConfirmation("Confirmation", "Êtes-vous sûr de vouloir supprimer ce créneau ?")) {
            try {
                ...
                resetForm();
                showAlert("Succès", "Le créneau a été supprimé avec succès.");
            } catch (SQLException e) {
    ...
    private void onSaveButtonClicked() {
        ...
        try {
            if (currentCreneau == null) {
                ...
                showAlert("Succès", "Le créneau a été créé avec succès.");
            } else {
                ...
                showAlert("Succès", "Le créneau a été mis à jour avec succès.");
            }
